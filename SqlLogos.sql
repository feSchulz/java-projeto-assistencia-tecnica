...
CREATE TABLE modelos (
    ...
    tipo_equipamento tinyint(1)  NOT NULL, -- 0 para notebook e 1 para Smartphone
    modelo varchar(45) not null,
    CONSTRAINT fkmarca FOREIGN KEY (marca_id)
	REFERENCES marca (id)
);
...
CREATE TABLE cidade (
    ...
    CONSTRAINT fkestado FOREIGN KEY (id_estado)
...
CREATE TABLE endereco (
    ...
    CONSTRAINT fkcidade FOREIGN KEY (cidade_id)
...
CREATE TABLE funcionario (
    ...
    login VARCHAR(25),
    senha VARCHAR(200),
    CONSTRAINT fkendereco FOREIGN KEY (endereco_id)
...
CREATE TABLE clientes (
    ...
    CONSTRAINT fkenderecocliente FOREIGN KEY (endereco_id)
        REFERENCES endereco (id)
);
